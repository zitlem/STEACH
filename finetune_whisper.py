"""
LoRA fine-tuning for Whisper using PEFT.
Reads training pairs from a JSONL manifest and saves a fine-tuned model
(LoRA adapter + merged CTranslate2 version) to output_dir.
